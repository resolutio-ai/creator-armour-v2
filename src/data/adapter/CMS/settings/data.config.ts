...
export const landingPageData = {
  events: {
    ...
    "description": "Embark on a creative journey with our workshops, demystifying the art of protection. Engage in exciting competitions that celebrate your artistic talent. Stay tuned for upcoming events shaping your path in the realm of art safeguarding!",
    "btnText": "See more",
    "link": "https://resolutio.notion.site/Events-Workshops-40501f61e9fb4ee6afcd7673bfbc128f?pvs=4",
    "isExternal": true,
    "imageURL": "https://raw.githubusercontent.com/resolutio-ai/CMS/main/images/banners/Host%20a%20Workshop.png",
    "isGIF": false,
    "imagePosition": "left",
    "showAuthor": false,
    "author": {
      ...
      "artName": "",
      "profileLink": "https://resolutio.notion.site/IBWDesignChallenge-becf5eb882784daf80c8cf2d4d4f8e6c?pvs=4"
    }
  },
  ourStory: {
    "heading": "Protection: The Default Integration",
    "description": "We're on a mission to protect you from exploitation, so you can focus on what you do best: creating art. Read on to discover our story and how we are building a safe haven for you.",
    "btnText": "Our Story",
    "link": "https://youtu.be/Vjzx1ZSgSdU",
    "isExternal": true,
    "imageURL": "https://raw.githubusercontent.com/resolutio-ai/CMS/main/images/banners/Memoria-Poster-4.jpg",
    "isGIF": false,
    "imagePosition": "right",
    "showAuthor": true,
    "author": {
  ...
  resolveDispute: {
    ...
    "description": "Unlock affordable dispute resolution with resolutio – the go-to platform for creators seeking a cost-effective alternative to resolve conflicts, ensuring your artistic endeavors are protected",
    "btnText": "Resolve",
    "link": "/coming-soon",
    "isExternal": false,
    "imageURL": "https://raw.githubusercontent.com/resolutio-ai/CMS/601ec785cf6c81975a6a8524333bfe79821d2e00/images/banners/Solace%20Cover.jpg",
    "isGIF": false,
    "imagePosition": "left",
    "showAuthor": true,
    "author": {
  ...
  lavenderLink:
  {
    ...
    "description": "resolutio is a creator led collective. Come be a part of the collective to access the exclusive perks for LH Collective.",
    "link": "/coming-soon",
    "isExternal": false,
    ...
    "blogList": [
      {
        ...
        "description": "Art is not always a one-(wo)man show, although creating art has been romanticised as the brainchild of one particular author/creator. Art, and its various expressions, often result from teamwork and involve multiple parties working together with a shared aim to build a final product.",
        "imageURL": "https://raw.githubusercontent.com/resolutio-ai/CMS/main/images/blogs/article_1.jpg"
      },
      {
        "id": 2,
        ...
        "description": "In continuation of our discussion on PFP projects, an interesting occurrence that took place last week was the announcement made by Mousebelt, to create an ‘instruction manual to Bored Ape Yacht Club (BAYC) owners to utilize the IP rights of their NFTs.’",
        "imageURL": "https://raw.githubusercontent.com/resolutio-ai/CMS/main/images/blogs/article_2.jpg"
      },
      {
        "id": 3,
        ...
        "imageURL": "https://raw.githubusercontent.com/resolutio-ai/CMS/main/images/blogs/article_3.png"
      }
    ]
  }
}

export const WAITLIST_URL = "https://docs.google.com/forms/d/e/1FAIpQLSdFA8JiIw1Dnfmv8uRlnLnw8wSCiH3ENT7qO6I_pIMoTLaafQ/viewform";